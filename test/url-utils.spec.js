...
describe('urlUtils', function() {
  ...
  describe('appendKeyToURL', function () {
    it('must add value', function () {
      assert.equal(urlUtils.appendKeyToURL('http://www.example.com', 'par1', 'hello'), 'http://www.example.com?par1=hello');
      assert.equal(urlUtils.appendKeyToURL('http://www.example.com', 'par1', 'hello world'), 'http://www.example.com?par1=hello%20world');
      assert.equal(urlUtils.appendKeyToURL('http://www.example.com', 'par1', true), 'http://www.example.com?par1=true');
    });

    it('must add value with other pars', function () {
      assert.equal(urlUtils.appendKeyToURL('http://www.example.com?a=1', 'par1', 'hello'), 'http://www.example.com?a=1&par1=hello');
      assert.equal(urlUtils.appendKeyToURL('http://www.example.com?a=1#xxx', 'par1', 'hello'), 'http://www.example.com?a=1&par1=hello#xxx');
    });
  });
});